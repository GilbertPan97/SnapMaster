macro(create_win32_resource_version)
	if(MSVC) # TODO: MinGW (http://www.mingw.org/wiki/MS_resource_compiler)
		...
		set(_ext "ico")
		set(_companyname "Robotics Co., Ltd.")
		set(_copyright "Copyright (C) 2020 by JiabinPan")
		set(_description "Software develop with Qt")
		set(cmd "_target")
		foreach(arg ${ARGN})
		...
		file(APPEND ${RC_FILE} "    BEGIN\n")
		file(APPEND ${RC_FILE} "        VALUE \"Translation\", 0x0409, 1200\n")
		file(APPEND ${RC_FILE} "    END\n")
		file(APPEND ${RC_FILE} "END\n")
