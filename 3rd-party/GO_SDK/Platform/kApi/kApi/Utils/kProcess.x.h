...
/** 
 * [Deprecated] This function does way too many things and is deprecated.
 * 
 * Please use:
 ...
 * The exit code parameter receives the exit code of the child. If the child was 
 * terminated or in case of an error the exit code becomes k64S_MAX.
 * 
 ...
 */
kDeprecateEx kInlineFx(kStatus) kProcess_Wait(kProcess process, k64u timeout, k64s * exitCode)
{
    return kProcess_LegacyWaitImpl(process, timeout, exitCode);
}
